...
async function predict() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            let title = "<div class='" + poke_array[yourpoke] + "-pocketmon-title'>" + resultTitle + "</div>"
            let explain = "<div class='pocketmon-explain pt-2'>" + resultExplain + "</div>"
            let celeb = "<div class='" + poke_array[yourpoke] + "-pocketmon-celeb pt-2 pb-2'>" + resultCeleb + "</div>"
            ...
            for (let i = 0; i < predstr.length; i++) {
                ...
                let label = "<div class='pocketmon-label d-flex align-items-center'>" + labelTitle + "</div>"
